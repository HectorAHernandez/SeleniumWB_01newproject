...
import pageFactory.Guru99EditCustomer;		//This pages are created in the "pagesFactory" folder or package
import pageFactory.Guru99DeleteCustomer;	//This pages are created in the "pagesFactory" folder or package
import pageFactory.Guru99NewAccount;		//This pages are created in the "pagesFactory" folder or package
import pageFactory.Guru99SelectAccount;		//This pages are created in the "pagesFactory" folder or package
import pageFactory.Guru99EditAccount;		//This pages are created in the "pagesFactory" folder or package
...
public class UsingPOM_03_PageFactoryComplete {
    WebDriver driver;
    Guru99Login objLogin;                      //This pages are created in the "pagesFactory" folder or package      
    Guru99HomePage objHomePage;  			   // One objectPage for each one of the page to automate.	
...
//        driver.manage().timeouts().implicitlyWait(10, TimeUnit.SECONDS);
    ...
    //Verify home page use id, it could be any other field or title.
   ...
   // create new customer object: *** NOT NEEDED BECAUSE IT WAS CREATED IN PREVIOUS TEST #10 and object objNewCustomer
   // was defined at the class level, see line 31.
//        objNewCustomer = new Guru99NewCustomer(driver); 
     // Go to create a new customer by clicking on "New customer" link
        objNewCustomer.clickNewCustomerLink();
   ...
   /* Note if there is another field (like gender="wrong22") that needed to be validated in this same page, it
